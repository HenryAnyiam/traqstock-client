...
function Header({ extraClass }) {
  ...
  return (
    <header className={`z-4 w-full h-10 p-2 pr-4 shadow-lg bg-white flex flex-wrap items-center justify-end ${extraClass}`}>
      ...
      <div className='fixed top-9 border p-2 bg-white rounded-md shadow-md z-50' id="profile-modal">
