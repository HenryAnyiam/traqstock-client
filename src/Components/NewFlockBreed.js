...
import { addFlockBreed, handleData } from '../Utils/Funcs';
import { toast } from 'react-toastify';

function NewFlockBreed() {
  ...
  <div className="bg-base-brown/[.3] shadow-2xl rounded-xl h-fit w-80 lg:w-fit p-4">
      <p className="text-center rounded-xl font-bold font-serif text-hover-gold p-1 w-full mb-2 text-xl">New Flock Breed</p>
